...
CREATE TABLE jc_student_order (
    ...
    FOREIGN KEY (h_passport_office_id) REFERENCES jc_passport_office(ps_office_id) ON DELETE RESTRICT,
    ...
    FOREIGN KEY (w_passport_office_id) REFERENCES jc_passport_office(ps_office_id) ON DELETE RESTRICT,
    FOREIGN KEY (w_university_id) REFERENCES jc_university(university_id) ON DELETE RESTRICT,
    FOREIGN KEY (register_office_id) REFERENCES jc_register_office(reg_office_id) ON DELETE RESTRICT
);
...
CREATE TABLE jc_student_child (
    ...
    FOREIGN KEY (c_register_office_id) REFERENCES jc_register_office(reg_office_id) ON DELETE RESTRICT
)
